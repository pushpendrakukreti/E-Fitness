<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeFile="Trainer.aspx.cs" Inherits="Fitness_Hub.admin.Trainer" %>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 mt-2">
                                        <asp:RadioButtonList runat="server" class="fradio" ID="genderDDlist" RepeatDirection="Horizontal">
                                ...
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Photograph</label>
                                    <div class="col-sm-9">
