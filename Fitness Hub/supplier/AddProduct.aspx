<%@ Page Title="" Language="C#" MasterPageFile="~/supplier/Site1.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Fitness_Hub.supplier.AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GymCon %>" SelectCommand="SELECT [SupplierName] FROM [Supplier]"></asp:SqlDataSource>
</asp:Content>
