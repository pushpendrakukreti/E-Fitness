<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Fitness_Hub.supplier.index" %>
            ...
            <div class="card card-authentication1 mx-auto my-5 animated bounceInDown">
                <div class="card-body" style="background: linear-gradient(20deg, #682a2a, #302a68); color: white;">
                    ...
                    <div class="card-content p-2">
                        ...
                        <div class="card-title text-uppercase text-center py-3" style="color: white; font-family: arial;">SUPPLIER (Sign In)</div>
                        ...
                        <style>
                            .stylebtn{
                                ...
                                <asp:Button ID="btnlog" runat="server" Text="Login" CssClass="btn btn-primary btn-round btn-block waves-effect waves-light stylebtn" OnClick="btnlog_Click"/>
                        <hr />
